...
<section class="hero">
  <div class="container">
    <div class="hero-content">
      <div class="banner-wrap"><img class="banner-img" src="../assets-new/media/banners/makeup.jpg" alt="Forever Makeup Artist 2026 — apply now" loading="eager" onerror="this.closest('.banner-wrap').style.display='none'"><span class="banner-shine"></span></div>
      <h1>Makeup Artist 2026</h1>
  ...
  <div class="container">
    ...
    <div class="form-container">
      <div class="form-header">
        <h2>Forever Makeup Artist Registration</h2>
        <p>Join us now!</p>
      </div>

      <form id="registrationForm" onsubmit="submitForm(event)" data-category="Forever Makeup Artist 2026">
