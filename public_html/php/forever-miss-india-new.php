  ...
  <div class="container">
    <div class="hero-content">
      <div class="banner-wrap">
        <img class="banner-img" src="../assets-new/media/banners/banner-miss-india.webp" alt="Forever Miss India 2026 — Auditions open" width="1200" height="630" onerror="this.closest('.banner-wrap').style.display='none'">
  ...
  <div class="container">
    ...
    <div class="form-container">
      <div class="form-header">
        <h2>Miss India Registration</h2>
        <p>Join us now!</p>
      </div>

      <form id="registrationForm" onsubmit="submitForm(event)" data-category="Forever Miss India 2026">
