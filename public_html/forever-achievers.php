...
<title>Forever Achievers Award 2026 Registration | Forever Star India</title>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">

<meta name="description" content="Register for Forever Achievers Award 2026 with Forever Star India (FSIA). Honouring achievers across 70+ categories. Apply online — auditions & nominations open from every city of India.">
<meta name="robots" content="index,follow">
<link rel="canonical" href="https://www.fsia.in/forever-achievers.php">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Forever Star India">
<meta property="og:title" content="Forever Achievers Award 2026 Registration | Forever Star India">
<meta property="og:description" content="Register for Forever Achievers Award 2026 with Forever Star India (FSIA). Honouring achievers across 70+ categories. Apply online — auditions & nominations open from every city of India.">
<meta property="og:url" content="https://www.fsia.in/forever-achievers.php">
<meta property="og:image" content="https://www.fsia.in/uploads/718Step-1.webp">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Forever Achievers Award 2026 Registration | Forever Star India">
    ...
    <div class="bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-12 border border-slate-100">
      ...
      <div class="md:col-span-8 p-8 md:p-10 bg-slate-50">
        <div class="mb-6 border-b border-slate-200 pb-4 text-center md:text-left">
          ...
          <h1 class="text-2xl md:text-3xl font-extrabold text-slate-900 font-playfair">Forever Achievers Registration</h1>
        </div>

      <form class="space-y-5" id="registrationForm" onsubmit="submitForm(event)" data-category="Forever Achievers 2026">
